...
function showMeMagicExterior() {
    ...
    para.style.cssText = 'position:absolute;top:130px;left:845px;  font-family: "Avant Garde", Avantgarde, "Century Gothic", CenturyGothic, "AppleGothic", sans-serif;font-size: 32px;padding: 80px 50px;text-align: center;text-transform: uppercase;text-rendering: optimizeLegibility;';
     //   PIErender();
    }
    else {
    //    if(count1%2==0)
...
//	count2+=1;
	if(toggle2) {
		...
		para.style.cssText = 'position:absolute;top:130px;left:360px; font-family: "Avant Garde", Avantgarde, "Century Gothic", CenturyGothic, "AppleGothic", sans-serif;font-size: 32px;padding: 80px 50px;text-align: center;text-transform: uppercase;text-rendering: optimizeLegibility;';
	}
	else {
	//	if(count2%2==0)
			toggle2=true;
...
function initialiseHelp()
{
    ...
    helpContent = helpContent + "<p> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<b>Back: </b>To decrease the number of sides.</p>";
    helpContent = helpContent + "<p> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<b>Go On: </b>To increase the number of sides.</p>";
