...
function initialiseControlVariables()
{
    ...
    VXdefault=1.0;             /* X Velocity Slider Default Value */
...
//Add balloon
    ...
    myballoon.position.set( 2.20, 0.629, 0.2);
...
//Water flow
    ...
    myFlow.position.set( 1.29, 0.80, 0.0);
...
// new level
    ...
    myFlowOther.position.set( 1.45, 0.669 , 0.0 );
...
//my tap
    ...
    PIEaddElement(tap1);
    tap1.position.set( 1.67, 2.19 , 0.0 );
    ...
    PIEaddElement(tap2);
    tap2.position.set( 1.67, 2.27 , 0.0 );
    ...
    PIEaddElement(tap3);
    tap3.position.set( 1.84, 2.05 , 0.0 );
...
//     ctx.moveTo(  0.266, 0.172  );
//     ctx.bezierCurveTo( 0.111, 0.079, 1.163, 0.078, 1.029, 0.155);
...
//level adjust
    if(count> levelAdjust) {
        ...
        levelAdj.position.set( 2.275, 0.775 , 0.0 );
